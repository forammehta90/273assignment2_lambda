...
def handler(event, context):
    ...
    if item["Item"]["order_status"]["S"] == "selecting":
        ...
        client.update_item(TableName="pizzashoporder",
                           ...
                           {":o": {"S":menu["Item"]["selection"]["L"][event["input"]-1]["S"]}})
        client.update_item(TableName="pizzashoporder",
                           Key={"order_id":{"S":event["order_id"]}},
    ...
    if item["Item"]["order_status"]["S"] == "ordering":
        ...
        client.update_item(TableName="pizzashoporder",
                           Key={"order_id":{"S":event["order_id"]}},
                           UpdateExpression="SET order.#o = :o",
                           ExpressionAttributeNames={"#o": "size"},
                           ExpressionAttributeValues=
                           {":o": {"S":menu["Item"]["size"]["L"][event["input"]-1]["S"]}})
        client.update_item(TableName="pizzashoporder",
                           Key={"order_id":{"S":event["order_id"]}},
                           UpdateExpression="SET #o = :o",
                           ExpressionAttributeNames={"#o": "order_status"},
        ...
        client.update_item(TableName="pizzashoporder",
                           ...
                           ExpressionAttributeValues=
                           {":o": {"N":menu["Item"]["price"]["L"][event["input"]-1]["N"]}})
        client.update_item(TableName="pizzashoporder",
                           Key={"order_id":{"S":event["order_id"]}},
                           UpdateExpression="SET order.#o = :o",
        ...
        response = response + menu["Item"]["price"]["L"][event["input"]-1]["N"] +". We will email you when the order is ready. Thank you!"
        return dict({"Message":response})